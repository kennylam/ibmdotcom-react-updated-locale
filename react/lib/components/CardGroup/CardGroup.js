...
var CardGroup = function CardGroup(_ref) {
  ...
  (0, _react.useEffect)(function () {
    ...
    _windowOrGlobal.default.addEventListener('resize', setCardHeight);

    return function () {
      return _windowOrGlobal.default.removeEventListener('resize', setCardHeight);
    };
  }, []);
  /**
  ...
  var setCardHeight = function setCardHeight() {
    _windowOrGlobal.default.requestAnimationFrame(function () {
      ...
      if (containerNode) {
        (0, _sameHeight.default)(containerNode.getElementsByClassName(":not(.".concat(prefix, "--card__video) ").concat(prefix, "--card__heading")), 'md');
        (0, _sameHeight.default)(containerNode.getElementsByClassName(":not(.".concat(prefix, "--card__video) ").concat(prefix, "--card__copy")), 'md');
        (0, _sameHeight.default)(containerNode.getElementsByClassName("".concat(prefix, "--card__eyebrow")), 'md');
        (0, _sameHeight.default)(containerNode.getElementsByClassName("".concat(prefix, "--card--link")), 'md');
      }
    });
  };
...
var _renderCards = function _renderCards(cards, containerRef, cta) {
  return _react.default.createElement("div", {
    ...
    }, _react.default.createElement(_CTA.CTA, {
      style: "card",
      key: index,
