...
var FeatureCard = function FeatureCard(_ref) {
  ...
  return card.cta && _react.default.createElement("div", {
    className: "".concat(prefix, "--feature-card"),
    "data-autoid": "".concat(stablePrefix, "--feature-card")
  }, _react.default.createElement(_Card.Card, (0, _extends2.default)({
    customClassName: "".concat(prefix, "--feature-card__card"),
    inverse: true,
    onClick: onClick
  }, card)));
};
