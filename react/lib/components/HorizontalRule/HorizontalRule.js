...
var HorizontalRule = function HorizontalRule(_ref) {
  ...
  return _react.default.createElement("hr", {
    ...
    className: (0, _classnames2.default)("".concat(prefix, "--hr"), (_classnames = {}, (0, _defineProperty2.default)(_classnames, "".concat(prefix, "--hr--").concat(type), type), (0, _defineProperty2.default)(_classnames, "".concat(prefix, "--hr--").concat(contrast), contrast), (0, _defineProperty2.default)(_classnames, "".concat(prefix, "--hr--").concat(size), size), (0, _defineProperty2.default)(_classnames, "".concat(prefix, "--hr--").concat(weight), weight), _classnames))
  });
};
...
HorizontalRule.propTypes = {
   ...
   */
  type: _propTypes.default.oneOf(['solid', 'dashed']),
   ...
   */
  size: _propTypes.default.oneOf(['fluid', 'small', 'medium', 'large']),
   ...
   */
  contrast: _propTypes.default.oneOf(['medium-contrast', 'low-contrast', 'high-contrast']),
   ...
   */
  weight: _propTypes.default.oneOf(['thin', 'thick'])
};
