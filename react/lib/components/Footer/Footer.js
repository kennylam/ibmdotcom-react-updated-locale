...
var Footer = function Footer(_ref) {
  ...
  }, type !== 'micro' && _react.default.createElement(_FooterLogo.default, null), (type === 'tall' || type === undefined) && _react.default.createElement(_FooterNav.default, {
    groups: footerMenuData
  }), type !== 'micro' && _loadLocaleLanguage(disableLocaleButton, localeButtonAria, displayLang, languageOnly, languageItems, languageInitialItem, languageCallback))), _react.default.createElement(_LegalNav.default, {
    links: footerLegalData,
    type: type,
    button: type === 'micro' ? _loadLocaleLanguage(disableLocaleButton, localeButtonAria, displayLang, languageOnly, languageItems, languageInitialItem, languageCallback) : null
  }));
};
/**
...
Footer.propTypes = {
   ...
   */
  type: _propTypes.default.oneOf(['tall', 'short', 'micro']),
