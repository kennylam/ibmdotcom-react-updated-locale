...
var MastheadTopNav = function MastheadTopNav(_ref) {
  ...
  var mastheadLinks = navigation.map(function (link, i) {
    ...
    if (link.hasMenu || link.hasMegapanel) {
      ...
      return _react.default.createElement(_HeaderMenuItem.default, {
        className: selected && "".concat(prefix, "--masthead__l0-nav--selected"),
        href: link.url,
        "data-autoid": autoid,
        key: i
      }, link.title);
  ...
  return _react.default.createElement(_react.default.Fragment, null, topNavProps.platform && _react.default.createElement(_HeaderName.default, {
    prefix: "",
    href: topNavProps.platform.url,
    "data-autoid": "".concat(stablePrefix, "--masthead-").concat(topNavProps.navType, "__l0-ecosystemname")
  }, topNavProps.platform.name), _react.default.createElement(_HeaderNavContainer.default, null, _react.default.createElement(_HeaderNavigation.default, {
    "aria-label": "IBM",
    "data-autoid": "".concat(stablePrefix, "--masthead__l0-nav")
  }, mastheadLinks)), _react.default.createElement("div", {
