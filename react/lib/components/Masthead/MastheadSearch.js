...
var _escaperegexp = _interopRequireDefault(require("@carbon/ibmdotcom-utilities/lib/utilities/escaperegexp/escaperegexp"));

var _HeaderGlobalAction = _interopRequireDefault(require("../../internal/vendor/carbon-components-react/components/UIShell/HeaderGlobalAction"));

var _Locale = _interopRequireDefault(require("@carbon/ibmdotcom-services/lib/services/Locale/Locale"));

var _MastheadSearchInput = _interopRequireDefault(require("./MastheadSearchInput"));

var _MastheadSearchSuggestion = _interopRequireDefault(require("./MastheadSearchSuggestion"));

var _propTypes = _interopRequireDefault(require("prop-types"));

var _windowOrGlobal = _interopRequireDefault(require("window-or-global"));

var _2 = _interopRequireDefault(require("@carbon/icons-react/lib/search/20"));

var _SearchTypeahead = _interopRequireDefault(require("@carbon/ibmdotcom-services/lib/services/SearchTypeahead/SearchTypeahead"));
...
var MastheadSearch = function MastheadSearch(_ref) {
      ...
      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _Locale.default.getLang();
  ...
  function useSearchVisible() {
    ...
    (0, _react.useEffect)(function () {
      _windowOrGlobal.default.document.addEventListener('keydown', handleHideSearch, true);

      _windowOrGlobal.default.document.addEventListener('click', handleClickOutside, true);

      return function () {
        _windowOrGlobal.default.document.removeEventListener('keydown', handleHideSearch, true);
  ...
  var className = (0, _classnames.default)((_cx = {}, (0, _defineProperty2.default)(_cx, "".concat(prefix, "--masthead__search"), true), (0, _defineProperty2.default)(_cx, "".concat(prefix, "--masthead__search--active"), state.isSearchOpen), _cx));
  /**
  ...
  function searchIconClick() {
    if (state.isSearchOpen && state.val.length) {
      _windowOrGlobal.default.parent.location.href = getRedirect(state.val);
    } else {
      dispatch({
        type: 'setSearchOpen'
      });
  ...
  function closeBtnAction() {
    ...
    var searchIconRef = _windowOrGlobal.default.document.querySelectorAll("[data-autoid=\"".concat(stablePrefix, "--masthead-").concat(navType, "__l0-search\"]"));
  ...
  function renderInputComponent(componentInputProps) {
    return _react.default.createElement(_MastheadSearchInput.default, {
  ...
  function renderSuggestion(suggestion, _ref4) {
    ...
    return _react.default.createElement(_MastheadSearchSuggestion.default, {
  ...
  function _onSuggestionsFetchRequest() {
    _onSuggestionsFetchRequest = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(request) {
      var searchValue, response;
      return _regenerator.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              searchValue = _trimAndLower((0, _escaperegexp.default)(request.value));
            ...
            case 6:
              _context2.next = 8;
              return _SearchTypeahead.default.getResults(searchValue);
  ...
  function onSuggestionSelected(event, _ref5) {
    ...
    _windowOrGlobal.default.parent.location.href = getRedirect(suggestionValue);
  }
  /**
  ...
  return _react.default.createElement("div", {
    ...
    className: className,
    ref: ref
  }, state.isSearchOpen && _react.default.createElement("form", {
  ...
  }, _react.default.createElement(_HeaderGlobalAction.default, {
    ...
    tabIndex: "0"
  }, _react.default.createElement(_2.default, null)), _react.default.createElement(_HeaderGlobalAction.default, {
...
MastheadSearch.propTypes = {
   ...
   */
  renderValue: _propTypes.default.number,
   ...
   */
  navType: _propTypes.default.oneOf(['default', 'alt', 'eco']),
