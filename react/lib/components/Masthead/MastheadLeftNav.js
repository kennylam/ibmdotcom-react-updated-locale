    ...
    section.menuItems.forEach(function (item, j) {
      ...
      if (item.megapanelContent) {
        sectionItems.push(_react.default.createElement(_SideNavMenuWithBackForward.default, {
          ...
          navType: navType,
          key: j
        }, renderNavItem(item.megapanelContent.quickLinks.links, dataAutoId), _react.default.createElement("button", {
          className: "".concat(prefix, "--masthead__focus"),
      ...
      if (j === section.menuItems.length - 1) {
        sectionItems.push(_react.default.createElement("button", {
          className: "".concat(prefix, "--masthead__focus"),
          onFocus: function onFocus(e) {
            preventOutFocus(e.target.parentElement.querySelector('a'), true);
          },
