...
var Card = function Card(_ref) {
  ...
  var inverse = _ref.inverse,
      ...
      props = (0, _objectWithoutProperties2.default)(_ref, ["inverse", "image", "eyebrow", "heading", "customClassName", "copy", "cta", "pictogram", "onClick"]);
...
function renderFooter(cta, pictogram) {
  ...
  }, (cta === null || cta === void 0 ? void 0 : cta.copy) && !pictogram && _react.default.createElement("span", {
    className: "".concat(prefix, "--card__cta__copy")
  }, cta === null || cta === void 0 ? void 0 : cta.copy), (cta === null || cta === void 0 ? void 0 : (_cta$icon = cta.icon) === null || _cta$icon === void 0 ? void 0 : _cta$icon.src) && !pictogram && _react.default.createElement(cta.icon.src, (0, _extends2.default)({
